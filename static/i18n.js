...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_desc_bot_name: 'Display name for the assistant throughout the UI. Defaults to seb.deb.',
    ...
    onboarding_title: 'Welcome to seb.deb',
