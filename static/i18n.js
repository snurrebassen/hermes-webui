...
const LOCALES = {
  en: {
    ...
    cmd_theme: 'Switch appearance (theme: system/dark/light, skin: default/ares/mono/slate/poseidon/sisyphus/charizard/sienna/sebadebian)',
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_desc_bot_name: 'Display name for the assistant throughout the UI. Defaults to seba.debian.',
    ...
    onboarding_title: 'Welcome to seba.debian',
    ...
    onboarding_open: 'Open seba.debian',
